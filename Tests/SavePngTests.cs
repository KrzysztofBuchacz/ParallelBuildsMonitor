...
using static ParallelBuildsMonitorTests.TestUtils;
...
namespace ParallelBuildsMonitor.Tests
{
    ...
    public class SavePngTests
    {
        ...
        {
            using (var guard = new MachineInfoIndependentScope()) // MachineInfo is in the picture, so make MachineInfo as machine independent string for test purposes
            {
